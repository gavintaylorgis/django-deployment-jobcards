...
class Job(models.Model):
    ...
    conctractor = models.ForeignKey(Contractor,related_name='jobs',on_delete=models.CASCADE,default=Contractor.objects.get(contractor_name="None"))
    status = models.ForeignKey(Status,related_name='jobs',on_delete=models.CASCADE,default=Status.objects.get(status_name='Requested'))
